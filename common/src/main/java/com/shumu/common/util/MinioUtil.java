...
public class MinioUtil {
    ...
    public static String upload(MultipartFile file, String bizPath, String customBucket) {
        String fileUrl = "";
        // 过滤上传文件夹名特殊字符，防止攻击
        bizPath = StringUtil.specialCharFilter(bizPath);
        ...
        try {
            ...
            String objectName = bizPath + TextConstant.SLASH
                    + (orgName.indexOf(".") == -1
            ...
            if (objectName.startsWith(TextConstant.SLASH)) {
            ...
            stream.close();
            fileUrl = minioUrl + newBucket + TextConstant.SLASH + objectName;
        } catch (Exception e) {
